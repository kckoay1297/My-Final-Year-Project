...
<h3 class="black">Past URL Record</h3>        
<table class="table table-condensed table-bordered">
<thead>
  <tr>
    <th>Type <i class="fa fa-sort sort" onclick="sort_table(people, 0, asc1); asc1 *= -1; asc2 = 1; asc3 = 1;"></i></th>
    <th>URL <i  class="fa fa-sort sort" onclick="sort_table(people, 1, asc1); asc1 *= -1; asc2 = 1; asc3 = 1;"></i></th>
    <th>Action <i  class="fa fa-sort sort" onclick="sort_table(people, 2, asc1); asc1 *= -1; asc2 = 1; asc3 = 1;"></i></th>
	</tr>
</thead>
  ...
  if ($conn->connect_error) {
	...
	while( $row = mysqli_fetch_array($res)) {
		...
		echo "<td><a href='add_link.php' target='_blank'><i class='fa fa-list-ul'></i> Add </a> ";
		echo "<a href='delete_link.php?id=".$row['l_index']."' target='_blank'><i class='fa fa-remove'></i> Delete </a></td>";
		echo "</tr>";
	}
	}else{
		echo "<tr>";
