...
<div class="box center">
	<form method="post" action="finish_edit_duty.php">

	<h3 class='topspace'>Edit Duty</h3>
<?php
	...
	$eid = $_GET['eid'];
	$uid = $_GET['uid'];
	$edit = "SELECT duty FROM event_checklist WHERE ec_index =".$eid;
	$res = $conn1->query($edit);
	if ($res->num_rows > 0) {
		echo "<textarea class='phone' id='edit' name='duty'>";
