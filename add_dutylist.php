...
<form action="finish_add_duty.php" method="post">
<input type="text" id="myInput" placeholder="Title..." class="form-control" name="duty">
...
if($res->num_rows > 0){
	while( $row = mysqli_fetch_array($res)) {
		if($row['status'] == 1){
		echo "<li class='list-group-item list-group-item-success'>".$row['duty']."</li>";
	}elseif($row['status'] == -1){
		echo "<li class='list-group-item list-group-item-danger'>".$row['duty']."</li>";
	}else{
		echo "<li class='list-group-item list-group-item-warning'>".$row['duty']."</li>";
	}
	}
}
