...
<ul class="topnav">
  ...
  <li class="right"><a href="#about">Logout</a></li>
	...
	$sql = "SELECT * FROM negativecase WHERE cIndex=".$id;
	$res=$con->query($sql);
	if ($res->num_rows > 0) {
...
<a href='create_event.php?app=0&id=0&id2=0' class='myBtn btn btn-primary btn-lg btn-block' role='button' id="myBtn">Create New Event</a>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
	...
	$sql = "SELECT * FROM member_record WHERE event_id ='$id2'";//.strtolower($id);
	$res=$con->query($sql);
	if ($res->num_rows > 0) {
		while( $row = mysqli_fetch_array($res)) {
			echo "<tr class='info'>";
