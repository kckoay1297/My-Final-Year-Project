...
<body>
<div class="container">
<h3 style="margin:5px">Link Description:</h2>
<form action="finish_add_link.php" method="post">
<input type="text" id="myInput" placeholder="Title..." class="form-control" name="name" required>
<h3 style="margin:5px">Paste URL:</h2>
<input type="url" id="myInput" placeholder="http://example.com" class="form-control" name="url" required>
<br>
<?php
