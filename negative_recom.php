...
<head>
  ...
  <link rel="stylesheet" href="/resources/demos/style.css">
	...
	<title>Event Mangement System: Negative Case Recommendation</title>
...
<div id="header-wrapper">
	<div id="header">
		<div id="logo">
			...
			<h4 class="topspace">Negative Case Recommendation</h4>
			</a>
		</div>
	</div>
</div>
...
<br></br>
<div class="container">
<form method="post" action="negative_cbr.php">
...
<a href='create_event.php?app=0&id=0' class='myBtn btn btn-primary btn-md btn-block' role='button'>Create New Event</a>
</div>
