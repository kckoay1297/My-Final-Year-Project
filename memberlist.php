...
<thead>
  ...
  if ($conn->connect_error) {
	...
	$sql="SELECT id,email, staffid, designation, department, firstname, lastname,phone,icnumber FROM user";
	$res = $conn->query($sql);
	while( $row = mysqli_fetch_array($res)) {
		...
		echo "<td><a href='user_profile.php?id=".$row["id"]."' target='_blank'>click me <i class='fa fa-external-link'></i></a></td>";
		echo "</tr>";
	}
  ?>
  </tbody>
