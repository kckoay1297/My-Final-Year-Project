...
<head>
  ...
  <link rel="stylesheet" href="/resources/demos/style.css">
	...
	<title>Event Mangement System: Upload File</title>
...
<div id="header-wrapper">
	<div id="header">
		<div id="logo">
			...
			<h4 class="topspace">Upload File</h4>
			</a>
		</div>
	</div>
</div>
...
<form action="finish_add_file.php" method="post" enctype="multipart/form-data">
<input type="text" id="myInput" placeholder="state the type of your file..." class="form-control" name="name">
...
echo "<h2 style='margin:5px'>Upload File:</h2>";
