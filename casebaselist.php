...
<thead>
  ...
  if ($conn->connect_error) {
	...
	while( $row = mysqli_fetch_array($res)) {
		...
		echo "<td><a href='case_profile.php?id=".$row["cIndex"]."&id2=".$row['caseID']."' target='_blank'><i class='fa fa-external-link'></i> View </a>
		<a href='edit_case.php?id=".$row["cIndex"]."' target='_blank'><i class='fa fa-edit'></i> Edit </a>
		<a href='remove_case.php?id=".$row["cIndex"]."' target='_blank'><i class='fa fa-ban'></i> Remove </a>
		</td>";
		echo "</tr>";
	}
  ?>
